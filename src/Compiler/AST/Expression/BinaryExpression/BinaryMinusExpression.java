...
public class BinaryMinusExpression extends Expression {
    private Expression leftExpression, rightExpression;

    private BinaryMinusExpression(Expression leftExpression, Expression rightExpression) {
    ...
    public String toString() {
        return "Binary Minus Expression";
    }
    ...
    public void generateInstruction(List<Instruction> instructionList) {
        ...
        instructionList.add(new BinaryInstruction(BinaryInstruction.BinaryOp.SUB, operand, rightExpression.getOperand()));
    }
}
